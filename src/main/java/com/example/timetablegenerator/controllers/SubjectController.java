...
public class SubjectController {
    ...
    public List<SubjectResponse> getAllSubjects() {
        log.debug("app | Fetching all subjects");
        return subjectService.getAllSubjects();
    }

    @GetMapping("/faculty/{facultyId}")
    public List<SubjectResponse> getSubjectsByFaculty(@PathVariable Long facultyId) {
        log.debug("app | Fetching subjects for faculty ID: {}", facultyId);
    ...
    public List<SubjectResponse> getSubjectsByDepartment(@PathVariable Long departmentId) {
        log.debug("app | Fetching subjects for department ID: {}", departmentId);
    ...
    public SubjectResponse getSubjectByCode(@PathVariable String code) {
        log.debug("app | Fetching subject with code: {}", code);
    ...
    public SubjectResponse createSubject(@Valid @RequestBody SubjectRequest request) {
        log.info("app | Creating new subject: {} ({}) - {} hours/week, majorId: {}",
    ...
    public SubjectResponse updateSubject(
        ...
        log.info("app | Updating subject ID: {} -> new name: {}, code: {}, majorId: {}",
    ...
    public void deleteSubject(
        ...
        log.info("app | Deleting subject with ID: {} using mode: {}", id, mode);
    ...
    public List<TeacherResponse> getTeachersBySubject(@PathVariable Long subjectId) {
        log.debug("app | Fetching teachers for subject ID: {}", subjectId);
